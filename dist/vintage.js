...
var getLUT = function getLUT(effect) {
  ...
  var id_arr = new Uint8ClampedArray(256).map(function(_, idx) {
    return idx;
  });
  ...
  return new Promise(function(resolve, reject) {
    ...
    if (effect.vignette) {
      ctx.globalCompositeOperation = supportsBlendModes
        ? 'multiply'
        : 'source-over';
      ctx.fillStyle = (0, _utils.getGradient)(ctx, width, height, [
        'rgba(0,0,0,0)',
        'rgba(0,0,0,0)',
    ...
    if (!viewfinder) {
      ...
      return (0, _utils.loadImageWithCache)(viewfinder).then(function(img) {
        if (supportsBlendModes) {
          ...
          var _createCanvasAndCtxFr = (0, _utils.createCanvasAndCtxFromImage)(
            img,
            width,
            height,
          ),
          ...
          imageData.data.set(
            imageData.data.map(function(v, i) {
